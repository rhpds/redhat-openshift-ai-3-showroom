...
With OpenShift AI 3.0 generally available, the recommended installation method is via Red Hat subscription manifests. This approach installs and manages the required operators using Red Hat’s Operator Lifecycle Manager (OLM).

1. Create a dedicated namespace for the OpenShift AI operators:

[source,bash]
----
oc create namespace redhat-ods-operators
----

2. Apply the OpenShift AI subscription manifest to your cluster:
